            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">กรอกภาคเรียน</h1>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">เจ้าหน้าที่เลือกภาคการศึกษา</h6>
                                    </div>
                                    <div class="card-body">
                                        <form id="term">
                                            <div class="a">
                                                <div class="row form-group">
                                                    <div class="col-md-5">
                                                        <label class="radio-inline"><input type="radio" name="term"
                                                                value="1" checked>&nbsp ภาคเรียนที่ 1</label><br>
                                                        <label class="radio-inline"><input type="radio" name="term"
                                                                value="2">&nbsp ภาคเรียนที่ 2</label><br>
                                                    </div>
