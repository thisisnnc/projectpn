                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ปีการศึกษา</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">2564</div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                สรุปรายงานการกู้ยืม</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">คลิกเพื่อดูไฟล์</div>
                                        </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form name="frmSearch" method="post" action="<?php echo $_SERVER['SCRIPT_NAME'];?>">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text"  name="txtKeyword" class="form-control" id="txtKeyword" value="<?php echo $strKeyword;?>"
                                            placeholder="ค้นหาจากรหัสนักศึกษา หรือ ชื่อจริง-นามสกุล"
                                            aria-label="folowstatus" aria-describedby="basic-addon2">
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-primary" type="submit">ติดตาม</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
include_once 'data.php';
   $sql = "SELECT * FROM user_info WHERE Name LIKE '%".$strKeyword."%'  OR Student_ID LIKE '%".$strKeyword."%' ";
...
ประเภทกองทุน : <?php
   ...
   รหัสนักศึกษา : <?php echo  $result["Student_ID"];?><br>
   ชื่อ-นามสกุล : <?php echo $result["Name"];?><br>
   เกรดเฉลี่ย : <?php echo $result["Grade"];?><br>
   รายได้ผู้ปกครอง/ปี(บาท) : <?php echo $result["Parent_Income"];?><br>
   จำนวนจิตอาสา(ชั่วโมง) : <?php echo $result["Volunteer"];?>   <br>             
   เบอร์ติดต่อ : <?php echo $result["Phone_Number"];?>       <br> 
