                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">เจ้าหน้าอัพโหลดไฟล์ PDF </h6>
                                    </div>
                                    <div class="card-body">
                                        <form action="บันทึกไฟล์PDFตารางกำหนดการ.php" name="form1" method="post" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="formFile"
                                            ...
                                            <div class="col-md-12 text-center">
                                                <input type="submit" class=btncolor:black value="ลบไฟล์" id="deletefile"
                                                    name="deletefile" class="btn ass_btn  ">
...
?>
                       <!-- Circle Buttons -->
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="บันทึกไฟล์รูปตารางกำหนดการ.php" name="form1" method="post"
                                            enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="formFile"
                                                    class="form-label">ไฟล์รูปภาพตารางกำหนดการ(แสดงเพียงแค่
                                                    รูปภาพเท่านั้น)</label>
                                                <input class="form-control" type="file" name="fileToUpload1"
                                                    id="fileToUpload1">
                                            </div>
                                            <div class="col-md-12 text-center">
                                                <input type="submit" class=btncolor:black value="ลบไฟล์" id="deletepic"
                                                    name="deletepic" class="btn ass_btn  ">
                                                <input type="submit" class=btncolor:black value="บันทึกไฟล์ลงระบบ"
...
$query = "SELECT * FROM file1" or die("Error:" . mysqli_error()); 
//3.เก็บข้อมูลที่ query ออกมาไว้ในตัวแปร result . 
$result = mysqli_query($objConnect, $query); 
//4 . แสดงข้อมูลที่ query ออกมา โดยใช้ตารางในการจัดข้อมูล: 
...
while($row = mysqli_fetch_array($result)) { 
  ...
  echo "<tr>";
  echo "<td>"."<img src='uploads1/".$row["file_name"]."' width='500'>"."</td>";
  echo "</tr>";
