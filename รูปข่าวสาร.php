                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="บันทึกรูปข่าวสาร.php" name="form1" method="post"
                                            ...
                                            <div class="col-md-12 text-center">
                                                <input type="submit" class=btncolor:black value="ลบไฟล์" id="deletepicinfo"
                                                    name="deletepicinfo" class="btn ass_btn  ">
...
while($row = mysqli_fetch_array($result)) { 
  ...
  echo "<tr>";
  echo "<td>"."<img src='uploadinfo/".$row["file_name"]."' width='500'>"."</td>";
  echo "</tr>";
